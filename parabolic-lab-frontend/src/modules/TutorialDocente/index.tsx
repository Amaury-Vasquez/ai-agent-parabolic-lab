...
const SECCIONES: SeccionDef[] = [
  { id: "bienvenida",  label: "Bienvenida",   titulo: "Bienvenida a ParabolicLab",           icono: <GraduationCap className="size-8" />, color: "text-primary" },
  { id: "salones",     label: "Mis Salones",  titulo: "Gestión de Salones",                  icono: <Home className="size-8" />,          color: "text-secondary" },
  { id: "biblioteca",  label: "Biblioteca",   titulo: "Biblioteca de Escenarios Didácticos", icono: <BookOpen className="size-8" />,       color: "text-accent" },
  { id: "reportes",    label: "Reportes",     titulo: "Monitoreo y Analítica",               icono: <BarChart3 className="size-8" />,     color: "text-info" },
  { id: "perfil",      label: "Mi Perfil",    titulo: "Configuración de Perfil",             icono: <User className="size-8" />,          color: "text-primary" },
  { id: "listo",       label: "Listo",        titulo: "Sistema Configurado",                 icono: <CheckCircle className="size-8" />,   color: "text-success" },
];
...
const Tip = ({ texto }: { texto: string }) => (
  <div className="flex gap-2 bg-primary/10 border border-primary/20 rounded-xl p-3 text-sm">
    ...
    <span><span className="font-semibold text-primary">Nota: </span>{texto}</span>
  </div>
);
  ...
  return (
    <div className="p-4 md:p-8 flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto">
      ...
      <main className="flex-1 min-w-0 flex flex-col gap-5">
        ...
        {/* ① Bienvenida */}
        <Seccion id="bienvenida" icono={<GraduationCap className="size-8" />} color="text-primary" titulo="Bienvenida a ParabolicLab">
          <p className="text-base leading-relaxed">
            <strong>ParabolicLab</strong> es una plataforma de gestión académica y simulación de tiro parabólico.
        ...
        {/* ② Gestión de Salones */}
        <Seccion id="salones" icono={<Home className="size-8" />} color="text-secondary" titulo="Gestión de Salones">
          <p className="leading-relaxed">
            Los <strong>salones</strong> representan sus grupos académicos. Desde el panel
        ...
        <Seccion id="biblioteca" icono={<BookOpen className="size-8" />} color="text-accent" titulo="Biblioteca de Escenarios Didácticos">
          <p className="leading-relaxed">
            La biblioteca es su repositorio central de material interactivo.
            Aquí puede diseñar nuevos escenarios físicos definiendo variables como
            <strong> velocidad</strong>, <strong>ángulo</strong>, <strong>gravedad</strong> y
        ...
        <Seccion id="reportes" icono={<BarChart3 className="size-8" />} color="text-info" titulo="Monitoreo y Analítica">
          <p className="leading-relaxed">
            Visualice el rendimiento de sus estudiantes de forma granular.
            El sistema aísla los datos por salón, permitiéndole evaluar el progreso,
        ...
        <Seccion id="perfil" icono={<User className="size-8" />} color="text-primary" titulo="Configuración de Perfil">
          <p className="leading-relaxed">
            Gestione su información institucional, actualice la asignatura
        ...
        {/* ⑥ Sistema Configurado */}
        <Seccion id="listo" icono={<CheckCircle className="size-8" />} color="text-success" titulo="Sistema Configurado">
          <p className="text-base leading-relaxed">
            Su entorno de trabajo está listo. Si requiere consultar este
            manual nuevamente, lo encontrará disponible en su panel de
            configuración de perfil.
          </p>
          <div className="flex justify-center mt-6">
            <Button variant="primary" className="active:scale-95" onClick={() => router.push("/docente")}>
